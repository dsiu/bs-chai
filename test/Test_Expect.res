...
describe("Expect", () => {
  ...
  describe("Combos.End", () => {
    ...
    it("to_deep_equal", () =>
      expect(list{{"a": 1}, {"a": 2}}) -> to_deep_equal(list{{"a": 1}, {"a": 2}}, _)
    )
    it("to_be", () => expect(list{{"a": 1}, {"a": 2}}) -> to_be(list{{"a": 1}, {"a": 2}}, _))
    it("to_be_a", () => expect("foo") -> to_be_a("string", _))
    it("to_be_ok", () => expect(true) -> to_be_ok)
    it("to_include", () => expect([1, 2, 3]) -> to_include(3, _))
    it("to_equal", () => expect(123) -> to_equal(123, _))
    it("to_eql", () => expect({"a": 1, "b": 2}) -> to_eql({"a": 1, "b": 2}, _))
    it("to_be_above", () => expect(2) -> to_be_above(1., _))
    it("to_be_below", () => expect(1) -> to_be_below(2., _))
    it("to_be_at_least", () => expect(1) -> to_be_at_least(0., _))
    it("to_be_at_most", () => expect(1) -> to_be_at_most(2., _))
    it("to_be_within", () => expect(1) -> to_be_within(0., 2., _))
    it("to_be_instanceof", () => expect([1, 2, 3]) -> to_be_instanceof(_Array, _))
    it("to_have_property", () => expect({"a": 1}) -> to_have_property("a", ~value=1, _))
    ...
    it("to_be_close_to", () => expect(1.23456) -> to_be_close_to(1.23, ~delta=0.01, _))
    it("to_have_members", () => expect([1, 2, 3]) -> to_have_members([2, 3, 1], _))
    it("to_be_one_of", () => expect(1) -> to_be_one_of([2, 3, 1], _))
    ...
    it("to_be_undefined", () => expect(Js.undefined) -> to_be_undefined)
    it("to_be_undefined", () => expect(nan) -> to_be_NaN)
    it("to_exist", () => expect(list{}) -> to_exist)
    it("to_be_empty", () => expect([]) -> to_be_empty)
    it("to_be_sealed", () => expect({"a": 1} -> seal) -> to_be_sealed)
    it("to_be_frozen", () => expect({"a": 1} -> freeze) -> to_be_frozen)
    it("to_be_finite", () => expect(1234) -> to_be_finite)
